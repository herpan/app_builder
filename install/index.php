...
<html>
	<head>
		...
		<title>Install | Wellcome to App Builder sharecode.com installer </title>
		<link href="https://maxcdn.bootstrapcdn.com/bootswatch/3.3.7/cosmo/bootstrap.min.css" rel="stylesheet">
	</head>
	<body>
    <div class="container">
        <div class="col-md-4 col-md-offset-4">
            <h1>Wellcome to App Builder sharecode.com installer</h1>
            <hr>
            <?php 
            ...
            ?>
                ...
                <?php 
                    ...
                    <p>Instalation Successfull, please remove installation folder</p>
                    </div>';
                }
            } 
            else {
        ...
        <footer>
            <div class="col-md-12" style="text-align:center;margin-bottom:20px">
                <hr>
                Copyright - 2017 | <a href="https://sharecode.com">sharecode.com</a>
            </div>
        </footer>
    </div>
